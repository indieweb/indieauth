  ...
  <body>
    ...
    <section class="normative">
      ...
      <section>
        ...
        <p>Clients MUST start by making a GET or HEAD request to [[!Fetch]] the user's profile URL to discover the necessary values. Clients MUST follow HTTP redirects (up to a self-imposed limit). If one or more successive HTTP permanent redirects (HTTP 301 or 308) are encountered starting with the very first request, the client MUST use the final permanently redirected-to URL as the user’s canonical profile URL. If a temporary redirect (HTTP 302 or 307) is encountered, they must still be resolved for discovery but it does not update the user’s canonical profile URL, nor do subsequent permanent redirects.</p>
